...
function showCalendarDayModal(date) {
  ...
  content.innerHTML = `
    <div style="text-align: center; margin-bottom: 20px;">
      ...
      <h2 style="margin: 0 0 10px 0; color: #333; font-size: 1.4em;">${
      ...
      ${
        isToday
          ? '<div style="background: #4A90E2; color: white; padding: 8px 16px; border-radius: 20px; display: inline-block; font-size: 0.9em;">Сьогодні</div>'
          : ""
      }
    </div>
